# 🧁 Sistema de Ventas POS - Dulce Ruth
...
*   **Tailwind CSS:** Framework utilizado para el diseño *Pixel Perfect* y utilidades de estilo responsivo.
...
*   **Microinteracciones:** Los botones de cambio de tarifa y el botón "+ AGREGAR" cuentan con estados de *hover* y *active* para proporcionar feedback inmediato al usuario.
